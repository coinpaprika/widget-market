...
```text
default: 'https://cdn.jsdelivr.net/npm/@coinpaprika/widget-market@1.0.0'
```
...
<div class="coinpaprika-market-widget" 
     ...
     data-update-timeout="30s"></div>
<script src="https://cdn.jsdelivr.net/npm/@coinpaprika/widget-market@1.0.0/dist/widget.min.js"></script>
```
